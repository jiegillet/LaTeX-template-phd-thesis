...
%-------------------------------------------------------------------------------
%	FOR THESIS BY PUBLICATION ONLY (delete section otherwise)
%-------------------------------------------------------------------------------

\usepackage[labeled, resetlabels]{multibib}
\newcites{Pub}{List of Publications} % Create separate bibliography for your publications
\bibliographystylePub{abbrvnat} % You may use a different style adapted to your field
...
\unnumberedchapter{List of Publications} % Title of the unnumbered chapter
\nocitePub{*} % Include all citations from Preamble/Thesis_publications.bib in order
\bibliographyPub{Preamble/Thesis_publications} % The references are in "Preamble/Thesis_publications.bib"
...
{
	% Hack: temporarily override addvspace to avoid spaces between chapters in lof/lot
...
\renewcommand\bibname{Reference List} % Title of the bibliography
\bibliography{Preamble/Thesis_bibliography} % The references are in "Preamble/Thesis_bibliography.bib"
...
\appendix
\addtocontents{toc}{\protect\contentsline{chapter}{Appendices}{}{}} % Add title to TOC
